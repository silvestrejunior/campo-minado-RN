...
const flagsUser = (board) => fields(board).filter(field=> field.flagged).length

export { cloneBoard, createMinedBoard, hadExplosion, invertFlag, openField, showMines, wonGame, flagsUser }
